...
#large VGG-16 based U-Net
def unet(pretrained_weights = None,input_size = (None,None,9)):
    ...
    #model.compile(optimizer = Adam(lr = 1e-8,decay=0.05), loss = 'hinge', metrics = ['accuracy'])
    #model.summary()
...
#small VGG-16 based U-Net
def unet2(pretrained_weights = None,input_size = (None,None,9)):
    inputs = Input(input_size)
...
#small VGG-like based U-Net
def unet3(pretrained_weights = None,input_size = (None,None,9)):
    inputs = Input(input_size)
    conv1 = Conv2D(32, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(inputs)
    conv1 = Conv2D(32, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv1)
    pool1 = MaxPooling2D(pool_size=(2, 2))(conv1)
